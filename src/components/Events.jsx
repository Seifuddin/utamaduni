            ...
            <SwiperSlide key={index}>
              ...
              >
                ...
                <div className="p-4 flex flex-col flex-1">
                  ...
                  <a
                    href="/gallery"
                    className="mt-auto inline-block bg-blue-50 border border-gray-300 text-blue-800 text-center text-sm px-4 py-2 rounded font-semibold hover:bg-blue-800 hover:text-white transition"
                  >
                    View Event
                  </a>
                </div>
