...
export default function CTA() {
  return (
    <section className="relative bg-amber-50 px-6 pb-10 overflow-hidden">
      <div className="mx-auto lg:px-6 text-center max-w-6xl text-white py16 ">
      ...
      <div className="relative inset-0 bg-[url('/images/patterns.png')] opacity-10 bg-cover bg-center z-0"></div>
        <div className="max-w-6xl mx-auto rounded-md px-3 py-16 text-center bg-gradient-to-r from-blue-900 to-blue-700">
          <h3 className="relative text-2xl md:text-3xl fontmedium font-serif font-bold text-white mb-4">Join Us in Making a Difference</h3>
          ...
          <div className="relative mt-6 flex justify-center gap-4">
            <a href="/donate" className="bg-blue-500 text-white px-5 py-3 rounded font-semibold shadow">Donate</a>
