  ...
  return (
    <section className="relative bg-amber-50 py-12 px6 md:px-12 overflow-hidden">
      ...
      >
        ...
        <h2 className="text-2xl md:text-3xl fontserif font-bold text-gray-900 mt-2 mb-3">
        ...
        {leaders.map((leader, index) => (
          <SwiperSlide key={index}>
            <motion.div
              ...
              className="group bg-white rounded-lg shadow-md hover:shadow-xl transition-all duration-300 p-5 text-center border border-gray-200 hover:border-amber-300"
            >
              {/* Profile Image */}
              ...
              <div className="hidden flex justify-center gap-3 mb-3">
                {leader.socials.facebook && (
                  <motion.a
                    ...
                    className="p-1.5 rounded-full textblue-800 bg-blue-200 border border-gray-300 shadow-md hover:bg-blue-200 transition"
                  >
